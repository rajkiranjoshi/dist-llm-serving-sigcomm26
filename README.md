...
├── README.md
├── artifacts/
│   └── llm-d-inference-sim-example/   # Hands-on llm-d deployment using the inference simulator
└── docs/
    ├── concept-to-llmd.md             # Mapping of networking/systems concepts to llm-d components
    └── prob-space-exploration.md      # Problem space exploration report
```
